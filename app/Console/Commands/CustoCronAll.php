...
class CustoCronAll extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'custo:cronall';
     ...
     * @var string
     */
    protected $description = 'Custo Cron All';
    ...
    GROUP BY 
        ...
        $id_masc = NULL;
        DB::table('custos_log_all')->delete();
        foreach ($lista_itens as $key => $item) {
            ...
            foreach ($lista_cores as $key => $lista_cor) {
                

            $id_masc =  $lista_cor->id_cor ?? NULL;
            $cor =  $lista_cor->cor ?? NULL;
            ...
            DB::table('custos_log_all')->insert([
                'cod_item' => $item->cod_item,
                'descricao' => $item->item,
                'id_masc' => $id_masc,
