								...
								<tbody>
									@foreach ($itens as $item)
										<tr>
											...
											<td 
											data-toggle="tooltip" data-placement="top" 
											title="(( 100-53.6-{{$item->custo_manual}}*100/{{$item->preco_com_4}})/100)*100"
											class='texto-azul center'>{{$item->margem_manual_4 ?number_format($item->margem_manual_4,2,',','.').'%' : NULL}}</td>
											<td 
											data-toggle="tooltip" data-placement="top" 
											title="(( 100-53.6-{{$item->custo_focco}}*100/{{$item->preco_com_4}})/100)*100"
											...
											<td 
											data-toggle="tooltip" data-placement="top" 
											title="(( 100-52.6-{{$item->custo_manual}}*100/{{$item->preco_com_3}})/100)*100"
											class='texto-azul center'>{{$item->margem_manual_3 ?number_format($item->margem_manual_3,2,',','.').'%' : NULL}}</td>
											<td 
											data-toggle="tooltip" data-placement="top" 
											title="(( 100-52.6-{{$item->custo_focco}}*100/{{$item->preco_com_3}})/100)*100"
